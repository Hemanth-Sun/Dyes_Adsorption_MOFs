...
st.markdown("""
    <style>
        ...
        /* Center text and add a distinct border to input boxes so they stand out */
        input[type="number"] {
            text-align: center;
    ...
    <div style="background-color: #FFFFFF; 
        ...
        <p style="color: #0052CC; text-align: center; font-size: 19px; font-weight: 600; margin-top: 5px;">Intelligent Equilibrium Capacity Estimation</p>
    </div>
""", unsafe_allow_html=True)
...
with footer_right:
    ...
    st.markdown(
        "This materials informatics platform utilizes two regressors: CatBoost + Gradient Boosting for Methylene Blue predictions and ExtraTrees for Methyl Orange predictions "
        "to predict the equilibrium adsorption capacity ($Q_e$) of Metal-Organic Frameworks (MOFs) and their composites."
    )